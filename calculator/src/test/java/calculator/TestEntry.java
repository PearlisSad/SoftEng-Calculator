...
public class TestEntry {
  ...
  /**
   * Creates an entry object of Symbol and checks getSymbol() returns the correct value. The test
   * allows for constructing and getting a symbol value.
   */
  @Test
  public void symValueTest() { // TEST 1 - Symbol entry constructor, getSymbol()
   ...
   */
  @Test
  public void floatValueTest() { // TEST 2 - Float entry constructor, getFloat()
   ...
   */
  @Test
  public void typValueTest() { // TEST 3 - Type entry constructor, getType()
   ...
   */
  @Test
  public void strValueTest() { // TEST 4 - String entry constructor, getString()
   ...
   */
  @Test
  public void toStringSymbolTest() { // TEST 5 - Symbol entry constructor, toString().
   ...
   */
  @Test
  public void toStringFloatTest() { // TEST 6 - Float entry constructor, toString().
   ...
   */
  @Test
  public void toStringTypeTest() { // TEST 7 - Type entry constructor, toString().
   ...
   */
  @Test
  public void toStringTest() { // TEST 8 - String entry constructor, toString().
